...
public class ListaProdutos {
    ...
    public void listarProdutos(){
        ...
        listaProcessadores.add(new Processador(6, "Intel", "Intel Core i3 14100F", "LGA 1700", 620, 60));
        listaProcessadores.add(new Processador(7, "Intel", "Intel Core i5 14400F", "LGA 1700", 1230, 65));
        listaProcessadores.add(new Processador(8, "Intel", "Intel Core i5-14600KF", "LGA 1700", 2000, 125));
        listaProcessadores.add(new Processador(9, "Intel", "Intel Core i7-14700KF", "LGA 1700", 2800, 125));
        ...
        listaPlacaDeVideos.add(new PlacaDeVideo(2, "NVIDIA","GeForce RTX 4080 Super", 420,9000));
        listaPlacaDeVideos.add(new PlacaDeVideo(3, "NVIDIA","GeForce RTX 4070 Super", 220,4000));
        ...
        listaPlacaDeVideos.add(new PlacaDeVideo(6, "AMD","Radeon RX 7800 XT", 260, 4000));
